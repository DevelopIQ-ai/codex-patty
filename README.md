...
| **Shows how much was cached** | The share of your prompt each subscription got at the cheap cached rate, per request, per key and overall, so you can see a warm conversation paying off and a cold one costing you. A subscription that has served nothing says so instead of reporting 0%. |
